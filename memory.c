...
bool memory_map_fixed(void *ptr, size_t size) {
  void *p = mmap(ptr, size, PROT_NONE, MAP_ANONYMOUS | MAP_PRIVATE | MAP_FIXED,
                 -1, 0);
...
static bool memory_protect_prot(void *ptr, size_t size, int prot,
                                UNUSED int pkey) {
#ifdef USE_PKEY
...
bool memory_remap_fixed(void *old, size_t old_size, void *new,
                        size_t new_size) {
  void *ptr =
...
bool memory_set_name(UNUSED void *ptr, UNUSED size_t size,
